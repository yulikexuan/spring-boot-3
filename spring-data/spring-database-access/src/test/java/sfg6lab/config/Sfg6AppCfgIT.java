...
@Slf4j
@DisplayName("Test JDBC DataSource - ")
...
class Sfg6AppCfgIT {
    ...
    void jdbcTemplate_Has_DataSource() {
        ...
        //When
        var actualDataSource = this.jdbcTemplate.getDataSource();
    ...
    void jdbc_Template_Search() {
        ...
        // When
        var lengths = this.jdbcTemplate.queryForList(
    ...
    void jdbc_Template_Query_Multi_Rows_With_Multi_Columns() {
        ...
        // When
        var nicknames = this.jdbcTemplate.queryForList(sql, date).stream()
    ...
    void jdbc_Template_Query_With_DataClassRowMapper() {
        ...
        // When
        List<NicknameLastseen> nicknames = this.jdbcTemplate.query(
    ...
    void jdbc_Template_Query_With_DataClassRowMapper_Not_Match_Col_Names() {
        ...
        // When
        List<NameLastSeen> nicknames = this.jdbcTemplate.query(
                sql, nicknameLastseenRowMapper, date);
    ...
    void jdbc_Query_For_Stream() {
        ...
        // When
        try (var names = this.jdbcTemplate.queryForStream(
                sql, nicknameLastseenRowMapper, date)) {
    ...
    void jdbc_Template_Query_With_Row_Callback_Handler() {
        ...
        // When
        this.jdbcTemplate.query(sql, rowHandler, expectedRows);
