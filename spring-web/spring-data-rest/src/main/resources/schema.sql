...
CREATE TABLE spring_data_jdbc.buyers (id serial PRIMARY KEY, version BIGINT default 0, active boolean, name varchar(32) UNIQUE NOT NULL, email varchar(32) NOT NULL, level integer, created timestamp NOT NULL);
